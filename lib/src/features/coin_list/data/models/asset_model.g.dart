...
AssetModel _$AssetModelFromJson(Map<String, dynamic> json) => AssetModel(
      ...
      dataStart: DateTime.parse(json['data_start'] as String),
      dataEnd: DateTime.parse(json['data_end'] as String),
      dataQuoteStart: DateTime.parse(json['data_quote_start'] as String),
      dataQuoteEnd: DateTime.parse(json['data_quote_end'] as String),
      dataOrderbookStart:
          DateTime.parse(json['data_orderbook_start'] as String),
      dataOrderbookEnd: DateTime.parse(json['data_orderbook_end'] as String),
      dataTradeStart: DateTime.parse(json['data_trade_start'] as String),
      dataTradeEnd: DateTime.parse(json['data_trade_end'] as String),
